(function (global, factory) {
	...
	(factory((global['vue-router-multi-view'] = {})));
...
function warn$1(msg, vm) {
  var trace = '';
  if (exports.Vue.config.warnHandler) {
    exports.Vue.config.warnHandler.call(null, msg, vm, trace);
  } else if (hasConsole && !exports.Vue.config.silent) {
...
function globalHandleError(err, vm, info) {
  if (exports.Vue.config.errorHandler) {
    try {
      return exports.Vue.config.errorHandler.call(null, err, vm, info);
    } catch (e) {
...
function install(pVue) {
  ...
  exports.Vue.component('router-multi-view', MultiView);
}
...
exports.RouterMultiView = RouterMultiView;
